...
from dataset2 import MaskBaseDataset
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(np.arange(len(dataset)))):
        ...
        for epoch in range(args.epochs):
            ...
            with torch.no_grad():
                ...
                val_acc = np.sum(val_acc_items) / len(val_set)                 # val_acc의 평균
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Custom_Vit_b_16', help='model type (default: Custom_Vit_b_16)')
...
# kfold 참조 : https://medium.com/dataseries/k-fold-cross-validation-with-pytorch-and-sklearn-d094aa00105f
